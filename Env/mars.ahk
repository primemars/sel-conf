...
#IfWinActive ahk_class Chrome_WidgetWin_0 
{
	...
	#r::Run https://reader.google.com
	#b::Run https://cig-bugzilla.isus.emc.com/
	#s::Run https://tvg01.lss.emc.com/svn/
	#v::Run http://cigreview.lss.emc.com/dashboard/
	#x::Run http://www.xiami.com/u/1200086
	#p::send season.cloudfoundry.com/proxy/url_with?url=http://
	#m::send shawn.x.z@gmail.com
	#q::Run http://vip.stock.finance.sina.com.cn/q/view/vCffex_Positions_cjcc.php
